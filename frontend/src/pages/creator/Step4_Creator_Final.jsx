        ...
        <div className="px-12 lg:px-20 py-16">
          ...
          <div className="mb-14">
            ...
            <div className="bg-[#f8fafc] rounded-2xl p-10 space-y-8 border border-gray-50">
              <p className="text-gray-500 text-[13px] font-medium leading-relaxed">We hold our creators to the highest standards of professional conduct to ensure a thriving ecosystem.</p>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <p className="text-gray-500 text-[13px] font-medium leading-relaxed">
                    <span className="text-[#050B18] font-bold">Commitment to high-quality content:</span> Delivering professional, original content that aligns with brand briefs.
                  </p>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <p className="text-gray-500 text-[13px] font-medium leading-relaxed">
                    <span className="text-[#050B18] font-bold">Authentic audience engagement:</span> Ensuring genuine interaction and transparent metrics.
                  </p>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <p className="text-gray-500 text-[13px] font-medium leading-relaxed">
                    <span className="text-[#050B18] font-bold">Deadline & Deliverable Reliability:</span> Honoring agreed-upon posting schedules and campaign requirements.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-14">
            ...
            <div className="space-y-8 px-2">
              {/* Checkbox 1 */}
              <div className="flex gap-6 items-start group cursor-pointer" onClick={() => toggleAgreement('influencer')}>
                <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all flex-shrink-0 mt-0.5 ${agreements.influencer ? 'bg-[#050B18] border-[#050B18]' : 'bg-white border-gray-200 group-hover:border-gray-300'}`}>
                  {agreements.influencer && <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>}
                </div>
...
export default Step4_Creator_Final;
